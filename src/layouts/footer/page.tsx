...
const Footer = () => {
  return (
    <section className='py-8 px-12' style={{borderTop: '1px solid #EFF0F6'}}>
      <Box sx={{display: 'flex', justifyContent: 'space-between', paddingBottom: 8,paddingTop: 8, borderBottom: '1px solid #2563EB'}}>
        <Box sx={{width: '22%'}}>
        ...
        <Box sx={{width: '22%', display: 'flex', flexDirection: 'column', gap:1}}>
