...
const ClientSays = () => {
    return (
        <section className='py-8 px-12' >
            ...
            <Box sx={{ display: "flex", gap: 3, marginTop: 4, paddingBottom:4, borderBottom:'1px solid #D9D9D9' }}>
                {
                    pageData.testimonials.map((item, index) => (
                        <Box key={index} sx={{ display: "flex", flexDirection: 'column', gap: 1.5, padding: 3, boxShadow: 'rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;', borderRadius: 2 }}>
