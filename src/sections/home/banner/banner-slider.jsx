                ...
                <SwiperSlide>
                    <Box sx={{display:"flex", flexDirection:"column", width: {xs: '90%', sm: '90%', md: '50%'} }}>
                        ...
                        <Box sx={{display:"flex", justifyContent: "center", gap:3, marginTop: 3,}}>
                                  <Button href='/products' variant="contained" sx={{ backgroundColor: 'white', fontWeight: 500, textTransform: 'none', color: '#1E3EA1',width: {md:'25%', sm:'30%', sx:'40%'}  }}>{hero.buttons[0].label}</Button>
                                  <Button
                                    href='/contact-us'
                                    variant="outlined"
                                    sx={{
